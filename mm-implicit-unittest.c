...
{
#define NUM_TESTS 10
	TestFunc fs[NUM_TESTS]= {test_next_chunk, test_mm_checkheap, test_ask_os_for_chunk, test_split, test_first_fit, test_mm_malloc, test_payload2header, test_coalesce, test_mm_free, test_mm_realloc};
